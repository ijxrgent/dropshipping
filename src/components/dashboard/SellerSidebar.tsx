...
const NAV_ITEMS = [
  { label: 'Mi tienda', href: '/dashboard/seller', icon: Store },
  { label: 'Productos', href: '/dashboard/seller/products', icon: Shirt },
  { label: 'Pedidos', href: '/dashboard/seller/orders', icon: Package },
  {
    label: 'Suscripción',
        ...
        >
          {!collapsed && (
            <span className="font-bold text-gray-900 text-sm truncate">
              ...
              <span className="ml-1.5 text-[10px] font-medium bg-teal-100 text-teal-700 px-1.5 py-0.5 rounded-full">
                Vendedor
              </span>
            </span>
          )}
