    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-5">
        ...
        <select
          ...
          className="w-full sm:w-auto h-10 px-3 pr-8 rounded-lg border border-gray-300 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition bg-white appearance-none cursor-pointer"
        >
